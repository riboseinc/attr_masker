...
image:https://img.shields.io/gem/v/attr_masker.svg[
	"Gem Version",
	link="https://rubygems.org/gems/attr_masker"]
image:https://img.shields.io/travis/riboseinc/attr_masker/master.svg[
	"Build Status",
	link="https://travis-ci.org/riboseinc/attr_masker"]
image:https://img.shields.io/codeclimate/github/riboseinc/attr_masker.svg[
	"Code Climate",
	link="https://codeclimate.com/github/riboseinc/attr_masker"]
image:https://img.shields.io/codecov/c/github/riboseinc/attr_masker.svg[
	"Test Coverage",
